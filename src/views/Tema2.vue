    ...
    .container.tarjeta.tarjeta--blanca.p-4.p-md-5    
      ...
      .row(data-aos="fade-left")
        ...
        .col-lg-7.col-22 
          ...
          p.p-2 Los componentes del #[em Raspberry Pi] son:
          .container.color-contenedornaranja
            ...
            .row(data-aos="fade-left")
                ...
                .col-lg-9.col-22.p-4
                  h4 Pantalla:
                  p La pantalla es un monitor o televisor con entrada #[em HDMI] o #[em DVI]. 
                .col-lg-11.col-22 
                  img(src="@/assets/curso/tema2/linea.png") 
            ...
            .row(data-aos="fade-left")
                ...
                .col-lg-9.col-22.p-4
                  h4 Teclado y #[em mouse]: 
                  p Periféricos #[em USB] de baja potencia con menos de 0.1ª.
                .col-lg-11.col-22 
                  img(src="@/assets/curso/tema2/linea.png")
            ...
            .row(data-aos="fade-left")
                ...
                .col-lg-10.col-22.p-4
                  h4 Tarjeta de memoria #[em SD]: 
                  p La tarjeta #[em SD] usada para #[em Raspberry Pi] debe ser al menos clase 4 con mínimo 8 Gb de capacidad de almacenamiento, la tarjeta #[em SD] necesita ser instalada sobre un sistema operativo desde otro computador. El proceso de instalación puede  ser realizada sobre #[em Windows, Mac, Linux, NOOBS y Raspbian.]
      .row.p-3
      .container.color-contenedorpink
        .row.justify-content-center.align-items-center(data-aos="fade-left")
          ...
          .col-lg-10.col-22.p-3
            h4 Ventajas de #[em Raspberry Pi]
            ol.lista-ol
              li 
              ...
              .container.tarjeta.tarjeta--blanca.p-4.p-md-5
                ImagenInfografica.color-acento-botones
                  ...
                  .tarjeta.color-acento-botones.p-3(x="70%" y="10%" numero="4")
                    ...
                    p Utilizaremos estos pines con instrucciones como #[em DigitalRead (), DigitalWrite (). AnalogRead () y AnalogWrite ()] funcionarán únicamente en los ìnes con el símbolo #[em PWM]
                  ...
                  .tarjeta.color-acento-botones.p-3(x="95%" y="45%" numero="13")
                    .h5.mb-2 13. ICSP
                    p #[em In-Circuit Serial Programming.]
                  ...
                  .tarjeta.color-acento-botones.p-3(x="70%" y="97%" numero="16")
                    .h5.mb-2 16. Vin
                    p Voltaje #[em Input]. Deberá llegarle una tensión regulada y estable (ya que no pasa por el regulador -nº12-) de 5V.
                  ...
                  .tarjeta.color-acento-botones.p-3(x="53%" y="97%" numero="20")
                    .h5.mb-2 20. #[em Reset pin]
                    p  Restablece el microcontrolador #[em ATmega]. A su izquierda está el conector #[em IOREF: Digital Reference input] V, y a continuación un pin reservado para futuras finalidades.
          ...
          .col-lg-10.col-22.p-3
            ...
            ol.lista-ol
              ...
              li 
                ...
                p El Arduino es un #[em software] de código abierto que puede ser programado con lenguajes #[em C, C++, AVR-C].
  </template>
