<template lang="pug">
  .curso-main-container.pb-3.tema3
    ...
    .container.tarjeta.tarjeta--blanca.p-4.p-md-5    
      ...
      SlyderF(columnas="col-lg-4 col-xl-4").p-4(data-aos="fade-right") 
        ...
        .tarjeta-avatar
          ...
          .tarjeta.fondo-slyderC
            .p-4
              h2 Cloud Gateway
              p Se usa para transmitir datos entre otros gateway y los servidores centrales IoT. 
        .tarjeta-avatar
      ...
      .row 
        .col-lg-2
          h4.subrayado-naranja.p-2 Modelo OSI
      P El modelo de interconexión de sistemas abiertos (OSI, por sus siglas en inglés), es un modelo de red creado por la ISO (Organización Internacional de Normalización) y se compone de siete capas:
      ...
      .topSquare02.clr--Yellow.mb-5(data-aos="fade-left")
        .row
          ...
          .col-lg-10
            p.mb-0 Es un protocolo simple para la transmisión de mensajes cortos de telemetría y control, desde o hacia una red de sensores / actuadores, es un protocolo de comunicación de máquina a máquina, machine to machine o M2M; este protocolo se localiza en las capas superiores del modelo OSI. <br><br>Existe un estándar MQTT a cargo del organismo OASIS que actualmente cuenta con la versión 5 del 7 de marzo de 2019; el protocolo MQTT se basa en el modelo de comunicación productor - consumidor.
      ...
      .row(data-aos="fade-left")
        .col-lg-8.col-22 
          ...
          p Aquí entra el concepto del Big Data que, según el Instituto Nacional de Estándares y Tecnologías (NIST), consiste de un extenso conjunto de datos principalmente con características de volumen, variedad, velocidad y variabilidad que requieren una arquitectura escalable para un almacenamiento, manipulación y análisis eficientes.
